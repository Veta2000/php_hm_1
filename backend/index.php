        ...
        <main>
            ...
            <div class="row g-5">
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" enctype="multipart/form-data" novalidate action="scripts/main.php" method="POST">
                        <div class="row g-3">
                            <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                <label for="file" class="form-label">Select File <span class="text-muted">(Optional)</span></label>
